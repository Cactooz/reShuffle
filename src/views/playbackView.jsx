	...
	return (
		<section className='playback'>
			<button
				...
				disabled={
					!props.loggedIn || props.executingPrevious || props.firstSong || props.firstPlaylist
				}
			>
			...
			<button
				...
				disabled={!props.loggedIn || props.executingPlayPause || props.firstPlaylist}
			>
				{props.isPlaying ? (
			...
			<button
				...
				disabled={!props.loggedIn || props.executingNext || props.firstPlaylist}
			>
				<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 320 512'>
